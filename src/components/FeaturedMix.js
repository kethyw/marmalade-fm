...
// neither of these two things, we want to display 
// our first mix as our featured mix 
...
const getMix = (state) => {
  ...
  // return featured mix if it exits, otherwise return the first mix 
...
// changing featured mix to show "currently viewing/playing"
